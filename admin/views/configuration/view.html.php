...
class EShopViewConfiguration extends JViewLegacy
{
	...
	function display($tpl = null)
	{
		...
		$lists['show_eshop_update']		= JHtml::_('select.booleanlist', 'show_eshop_update', ' class="inputbox" ', isset($config->show_eshop_update) ? $config->show_eshop_update : '0');
		...
		$lists['allow_notify']			= JHtml::_('select.booleanlist', 'allow_notify', ' class="inputbox" ', isset($config->allow_notify) ? $config->allow_notify : '1');
		...
		$lists['require_shipping']		= JHtml::_('select.booleanlist', 'require_shipping', ' class="inputbox" ', isset($config->require_shipping) ? $config->require_shipping : '1');
