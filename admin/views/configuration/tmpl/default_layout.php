...
<table class="admintable adminform">
	...
	<tr>
		...
		<td valign="top">
			<span class="help"><?php echo JText::_('ESHOP_CONFIG_SHIPPING_ADDRESS_FORMAT_HELP'); ?></span>
		</td>
	</tr>
	<tr>
		<td valign="top">
		...
		<td valign="top">
			<span class="help"><?php echo JText::_('ESHOP_CONFIG_PAYMENT_ADDRESS_FORMAT_HELP'); ?></span>
		</td>
	</tr>
	<tr>
		<td class="key" colspan="2">
