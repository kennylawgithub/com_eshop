			...
			<thead>
				<tr>
					...
					<th width="10%" class="text_right">
						...
						<?php echo JHtml::_('grid.order',  $this->items , 'filesave.png', 'weight.save_order' ); ?>
					</th>
					<th width="5%" class="text_center">
			...
			for ($i=0, $n=count( $this->items ); $i < $n; $i++)
			{
				...
				<tr class="<?php echo "row$k"; ?>">
					...
					<td class="order text_right">
						<span><?php echo $this->pagination->orderUpIcon( $i, true, 'weight.orderup', 'Move Up', $ordering ); ?></span>
						<span><?php echo $this->pagination->orderDownIcon( $i, $n, true, 'weight.orderdown', 'Move Down', $ordering ); ?></span>
