...
<script type="text/javascript">	
	Joomla.submitbutton = function(pressbutton)
	{
		...
		if (pressbutton == 'shipping.cancel') {
	...
	<div class="row-fluid">
		<div class="span6">
			<fieldset class="adminform">
				<legend><?php echo JText::_('ESHOP_SHIPPING_PLUGIN_DETAILS'); ?></legend>
		...
		<div class="span6">
			<fieldset class="adminform">
				<legend><?php echo JText::_('ESHOP_SHIPPING_PLUGIN_PARAMETERS'); ?></legend>
				<?php
