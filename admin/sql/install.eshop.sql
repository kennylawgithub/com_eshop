DROP TABLE IF EXISTS `#__eshop_addresses`;
CREATE TABLE IF NOT EXISTS `#__eshop_addresses` (
...
DROP TABLE IF EXISTS `#__eshop_attributedetails`;
CREATE TABLE IF NOT EXISTS `#__eshop_attributedetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_attributegroupdetails`;
CREATE TABLE IF NOT EXISTS `#__eshop_attributegroupdetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_attributegroups`;
CREATE TABLE IF NOT EXISTS `#__eshop_attributegroups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_attributes`;
CREATE TABLE IF NOT EXISTS `#__eshop_attributes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `attributegroup_id` int(11) DEFAULT NULL,
  `published` tinyint(1) unsigned DEFAULT NULL,
  `ordering` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_categories`;
CREATE TABLE IF NOT EXISTS `#__eshop_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `category_parent_id` int(11) DEFAULT NULL,
  `category_image` varchar(255) DEFAULT NULL,
  `category_customergroups` text,
...
DROP TABLE IF EXISTS `#__eshop_categorydetails`;
CREATE TABLE IF NOT EXISTS `#__eshop_categorydetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_configs`;
CREATE TABLE IF NOT EXISTS `#__eshop_configs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_countries`;
CREATE TABLE IF NOT EXISTS `#__eshop_countries` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `#__eshop_countries` (`id`, `country_name`, `iso_code_2`, `iso_code_3`, `postcode_required`, `published`) VALUES
...
DROP TABLE IF EXISTS `#__eshop_couponcustomergroups`;
CREATE TABLE IF NOT EXISTS `#__eshop_couponcustomergroups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_couponhistory`;
CREATE TABLE IF NOT EXISTS `#__eshop_couponhistory` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `coupon_id` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_couponproducts`;
CREATE TABLE IF NOT EXISTS `#__eshop_couponproducts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `coupon_id` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_coupons`;
CREATE TABLE IF NOT EXISTS `#__eshop_coupons` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_currencies`;
CREATE TABLE IF NOT EXISTS `#__eshop_currencies` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `currency_code` varchar(10) DEFAULT NULL,
  `currency_name` varchar(255) DEFAULT NULL,
  `left_symbol` varchar(12) DEFAULT NULL,
  `right_symbol` varchar(12) DEFAULT NULL,
  `decimal_symbol` char(1) DEFAULT NULL,
...
INSERT INTO `#__eshop_currencies` (`id`, `currency_code`, `currency_name`, `left_symbol`, `right_symbol`, `decimal_symbol`, `decimal_place`, `thousands_separator`, `exchanged_value`, `published`, `modified_date`) VALUES
(1, 'USD', 'US Dollar', '$', '', '.', '2', ',', 1.00000000, 1, '2013-05-20 06:13:03'),
(2, 'EUR', 'Euro', '', '€', '.', '2', ',', 0.77840000, 1, '2013-05-20 06:12:33'),
(3, 'GBP', 'Pound Sterling', '£', '', '.', '2', ',', 0.65780002, 1, '2013-05-20 06:12:33');

DROP TABLE IF EXISTS `#__eshop_customergroupdetails`;
CREATE TABLE IF NOT EXISTS `#__eshop_customergroupdetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `customergroup_id` int(11) DEFAULT NULL,
...
INSERT INTO `#__eshop_customergroupdetails` (`id`, `customergroup_id`, `customergroup_name`, `language`) VALUES
(1, 1, 'Default', 'en-GB');

DROP TABLE IF EXISTS `#__eshop_customergroups`;
CREATE TABLE IF NOT EXISTS `#__eshop_customergroups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `published` tinyint(1) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`)
) DEFAULT CHARSET=utf8;
INSERT INTO `#__eshop_customergroups` (`id`, `published`) VALUES
(1, 1);

DROP TABLE IF EXISTS `#__eshop_customers`;
CREATE TABLE IF NOT EXISTS `#__eshop_customers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_id` int(11) DEFAULT NULL,
  `customergroup_id` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__eshop_discountelements` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__eshop_discounts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_downloaddetails`;
CREATE TABLE IF NOT EXISTS `#__eshop_downloaddetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_downloads`;
CREATE TABLE IF NOT EXISTS `#__eshop_downloads` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_fielddetails`;
CREATE TABLE IF NOT EXISTS `#__eshop_fielddetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `#__eshop_fielddetails` (`id`, `field_id`, `title`, `description`, `place_holder`, `language`, `default_values`, `values`, `validation_error_message`) VALUES
...
DROP TABLE IF EXISTS `#__eshop_fields`;
CREATE TABLE IF NOT EXISTS `#__eshop_fields` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `#__eshop_fields` (`id`, `name`, `fieldtype`, `address_type`, `validation_rule`, `validation_rules_string`, `size`, `max_length`, `rows`, `cols`, `css_class`, `extra_attributes`, `access`, `multiple`, `required`, `ordering`, `published`, `is_core`) VALUES
...
DROP TABLE IF EXISTS `#__eshop_geozones`;
CREATE TABLE IF NOT EXISTS `#__eshop_geozones` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_geozonezones`;
CREATE TABLE IF NOT EXISTS `#__eshop_geozonezones` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_labeldetails`;
CREATE TABLE IF NOT EXISTS `#__eshop_labeldetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_labelelements`;
CREATE TABLE IF NOT EXISTS `#__eshop_labelelements` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `label_id` int(11) DEFAULT NULL,
  `element_id` int(11) DEFAULT NULL,
  `element_type` varchar(32) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_labels`;
CREATE TABLE IF NOT EXISTS `#__eshop_labels` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_lengthdetails`;
CREATE TABLE IF NOT EXISTS `#__eshop_lengthdetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `#__eshop_lengthdetails` (`id`, `length_id`, `length_name`, `length_unit`, `language`) VALUES
(1, 1, 'Centimeter', 'cm', 'en-GB'),
(2, 2, 'Inch', 'in', 'en-GB'),
(3, 3, 'Millimeter', 'mm', 'en-GB');

DROP TABLE IF EXISTS `#__eshop_lengths`;
CREATE TABLE IF NOT EXISTS `#__eshop_lengths` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `#__eshop_lengths` (`id`, `exchanged_value`, `published`, `ordering`, `created_date`, `created_by`, `modified_date`, `modified_by`, `checked_out`, `checked_out_time`) VALUES
(1, 1.00000000, 1, 1, '2013-04-24 09:58:39', 546, '2013-04-24 10:08:37', 546, 0, '0000-00-00 00:00:00'),
(2, 0.39370000, 1, 2, '2013-04-24 10:09:55', 546, '2013-04-24 10:09:55', 546, 0, '0000-00-00 00:00:00'),
(3, 10.00000000, 1, 3, '2013-04-24 10:10:20', 546, '2013-04-24 10:10:20', 546, 0, '0000-00-00 00:00:00');

DROP TABLE IF EXISTS `#__eshop_manufacturerdetails`;
CREATE TABLE IF NOT EXISTS `#__eshop_manufacturerdetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_manufacturers`;
CREATE TABLE IF NOT EXISTS `#__eshop_manufacturers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `manufacturer_customergroups` text,
  `published` tinyint(1) unsigned DEFAULT NULL,
  `ordering` int(11) DEFAULT NULL,
  `hits` int(11) DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_menus`;
CREATE TABLE IF NOT EXISTS `#__eshop_menus` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `#__eshop_menus` (`id`, `menu_name`, `menu_parent_id`, `menu_view`, `menu_layout`, `menu_class`, `published`, `ordering`) VALUES
...
DROP TABLE IF EXISTS `#__eshop_messagedetails`;
CREATE TABLE IF NOT EXISTS `#__eshop_messagedetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `#__eshop_messagedetails` (`id`, `message_id`, `message_value`, `language`) VALUES
...
(17, 17, '', 'en-GB'),
(18, 18, '<p>Hello,</p>\r\n<p>Thank you for your patience.<br /><br />Our [PRODUCT_NAME] is now in stock and can be purchased by the following link:Â <a href="[PRODUCT_LINK]">[PRODUCT_LINK]</a>.<br /><br />This is an one time notice, you will not receive this e-mail again.</p>\r\n<p>Thank you!</p>', 'en-GB');

DROP TABLE IF EXISTS `#__eshop_messages`;
CREATE TABLE IF NOT EXISTS `#__eshop_messages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `#__eshop_messages` (`id`, `message_title`, `message_name`, `message_type`) VALUES
...
DROP TABLE IF EXISTS `#__eshop_notify`;
CREATE TABLE IF NOT EXISTS `#__eshop_notify` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_optiondetails`;
CREATE TABLE IF NOT EXISTS `#__eshop_optiondetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_options`;
CREATE TABLE IF NOT EXISTS `#__eshop_options` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_optionvaluedetails`;
CREATE TABLE IF NOT EXISTS `#__eshop_optionvaluedetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_optionvalues`;
CREATE TABLE IF NOT EXISTS `#__eshop_optionvalues` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `option_id` int(11) DEFAULT NULL,
  `published` tinyint(1) unsigned DEFAULT NULL,
  `ordering` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_orderoptions`;
CREATE TABLE IF NOT EXISTS `#__eshop_orderoptions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_orderdownloads`;
CREATE TABLE IF NOT EXISTS `#__eshop_orderdownloads` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11) DEFAULT NULL,
  `order_product_id` int(11) DEFAULT NULL,
  `download_name` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_orderproducts`;
CREATE TABLE IF NOT EXISTS `#__eshop_orderproducts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11) DEFAULT NULL,
  `product_id` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_orders`;
CREATE TABLE IF NOT EXISTS `#__eshop_orders` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_orderstatusdetails`;
CREATE TABLE IF NOT EXISTS `#__eshop_orderstatusdetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `#__eshop_orderstatusdetails` (`id`, `orderstatus_id`, `orderstatus_name`, `language`) VALUES
(1, 1, 'Canceled', 'en-GB'),
...
DROP TABLE IF EXISTS `#__eshop_orderstatuses`;
CREATE TABLE IF NOT EXISTS `#__eshop_orderstatuses` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `published` tinyint(1) unsigned DEFAULT NULL,
  `ordering` int(11) DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
...
INSERT INTO `#__eshop_orderstatuses` (`id`, `published`, `ordering`, `created_date`, `created_by`, `modified_date`, `modified_by`, `checked_out`, `checked_out_time`) VALUES
...
DROP TABLE IF EXISTS `#__eshop_ordertotals`;
CREATE TABLE IF NOT EXISTS `#__eshop_ordertotals` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_payments`;
CREATE TABLE IF NOT EXISTS `#__eshop_payments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(1, 'os_paypal', 'Paypal', 'Giang Dinh Truong', '0000-00-00 00:00:00', 'Copyright 2010-2013 Ossolution Team', 'http://www.gnu.org/licenses/old-licenses/gpl-2.0.html GNU/GPL version 2', 'contact@joomdonation.com', 'www.joomdonation.com', '1.0', 'Paypal Payment Plugin for EShop', NULL, 1, 1),
...
DROP TABLE IF EXISTS `#__eshop_productattributedetails`;
CREATE TABLE IF NOT EXISTS `#__eshop_productattributedetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_productattributes`;
CREATE TABLE IF NOT EXISTS `#__eshop_productattributes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) DEFAULT NULL,
  `attribute_id` int(11) DEFAULT NULL,
  `published` tinyint(1) unsigned DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_productcategories`;
CREATE TABLE IF NOT EXISTS `#__eshop_productcategories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) DEFAULT NULL,
  `category_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `#__eshop_productdetails`;
CREATE TABLE IF NOT EXISTS `#__eshop_productdetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) DEFAULT NULL,
  `product_name` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_productdiscounts`;
CREATE TABLE IF NOT EXISTS `#__eshop_productdiscounts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) DEFAULT NULL,
  `customergroup_id` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_productdownloads`;
CREATE TABLE IF NOT EXISTS `#__eshop_productdownloads` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) DEFAULT NULL,
  `download_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `#__eshop_productimages`;
CREATE TABLE IF NOT EXISTS `#__eshop_productimages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_productoptions`;
CREATE TABLE IF NOT EXISTS `#__eshop_productoptions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) DEFAULT NULL,
  `option_id` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_productoptionvalues`;
CREATE TABLE IF NOT EXISTS `#__eshop_productoptionvalues` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_option_id` int(11) DEFAULT NULL,
  `product_id` int(11) DEFAULT NULL,
  `option_id` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_productrelations`;
CREATE TABLE IF NOT EXISTS `#__eshop_productrelations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_products`;
CREATE TABLE IF NOT EXISTS `#__eshop_products` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `manufacturer_id` int(11) DEFAULT NULL,
  `product_sku` varchar(64) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_productspecials`;
CREATE TABLE IF NOT EXISTS `#__eshop_productspecials` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) DEFAULT NULL,
  `customergroup_id` int(11) DEFAULT NULL,
  `priority` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_producttags`;
CREATE TABLE IF NOT EXISTS `#__eshop_producttags` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_quoteoptions`;
CREATE TABLE IF NOT EXISTS `#__eshop_quoteoptions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_quoteproducts`;
CREATE TABLE IF NOT EXISTS `#__eshop_quoteproducts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `quote_id` int(11) DEFAULT NULL,
  `product_id` int(11) DEFAULT NULL,
  `product_name` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_quotes`;
CREATE TABLE IF NOT EXISTS `#__eshop_quotes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_id` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_reviews`;
CREATE TABLE IF NOT EXISTS `#__eshop_reviews` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) DEFAULT NULL,
  `customer_id` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_shippings`;
CREATE TABLE IF NOT EXISTS `#__eshop_shippings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) DEFAULT NULL,
  `title` varchar(100) DEFAULT NULL,
  `author` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_stockstatusdetails`;
CREATE TABLE IF NOT EXISTS `#__eshop_stockstatusdetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `#__eshop_stockstatusdetails` (`id`, `stockstatus_id`, `stockstatus_name`, `language`) VALUES
(1, 1, '2 - 3 Days', 'en-GB'),
(2, 2, 'In Stock', 'en-GB'),
(3, 3, 'Out Of Stock', 'en-GB'),
(4, 4, 'Pre-Order', 'en-GB');

DROP TABLE IF EXISTS `#__eshop_stockstatuses`;
CREATE TABLE IF NOT EXISTS `#__eshop_stockstatuses` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `published` tinyint(1) unsigned DEFAULT NULL,
  `ordering` int(11) DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
...
INSERT INTO `#__eshop_stockstatuses` (`id`, `published`, `ordering`, `created_date`, `created_by`, `modified_date`, `modified_by`, `checked_out`, `checked_out_time`) VALUES
...
DROP TABLE IF EXISTS `#__eshop_tags`;
CREATE TABLE IF NOT EXISTS `#__eshop_tags` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_taxclasses`;
CREATE TABLE IF NOT EXISTS `#__eshop_taxclasses` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_taxcustomergroups`;
CREATE TABLE IF NOT EXISTS `#__eshop_taxcustomergroups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_taxes`;
CREATE TABLE IF NOT EXISTS `#__eshop_taxes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `geozone_id` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_taxrules`;
CREATE TABLE IF NOT EXISTS `#__eshop_taxrules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `#__eshop_themes`;
CREATE TABLE IF NOT EXISTS `#__eshop_themes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) DEFAULT NULL,
  `title` varchar(100) DEFAULT NULL,
  `author` varchar(255) DEFAULT NULL,
...
INSERT INTO `#__eshop_themes` (`id`, `name`, `title`, `author`, `creation_date`, `copyright`, `license`, `author_email`, `author_url`, `version`, `description`, `params`, `ordering`, `published`) VALUES
(1, 'default', 'Default', 'Giang Dinh Truong', '0000-00-00 00:00:00', 'Copyright 2007-2010 Ossolution Team', 'http://www.gnu.org/licenses/old-licenses/gpl-2.0.html GNU/GPL version 2', 'contact@joomdonation.com', 'www.joomdonation.com', '1.0', 'Default theme for EShop', '', 1, 1);

DROP TABLE IF EXISTS `#__eshop_urls`;
CREATE TABLE IF NOT EXISTS `#__eshop_urls` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `md5_key` text,
  `query` text,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `#__eshop_weightdetails`;
CREATE TABLE IF NOT EXISTS `#__eshop_weightdetails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `#__eshop_weightdetails` (`id`, `weight_id`, `weight_name`, `weight_unit`, `language`) VALUES
(1, 1, 'Kilogram', 'kg', 'en-GB'),
(2, 2, 'Gram', 'g', 'en-GB'),
(3, 3, 'Ounce', 'oz', 'en-GB'),
(4, 4, 'Pound', 'lb', 'en-GB');

DROP TABLE IF EXISTS `#__eshop_weights`;
CREATE TABLE IF NOT EXISTS `#__eshop_weights` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `exchanged_value` decimal(15,8) DEFAULT NULL,
  `published` tinyint(1) unsigned DEFAULT NULL,
  `ordering` int(11) DEFAULT NULL,
...
INSERT INTO `#__eshop_weights` (`id`, `exchanged_value`, `published`, `ordering`, `created_date`, `created_by`, `modified_date`, `modified_by`, `checked_out`, `checked_out_time`) VALUES
...
(3, 35.27400000, 1, 3, '2013-04-24 10:14:08', 546, '2013-04-24 10:14:08', 546, 0, '0000-00-00 00:00:00'),
(4, 2.20460000, 1, 4, '2013-04-24 10:14:33', 546, '2013-04-24 10:14:33', 546, 0, '0000-00-00 00:00:00');

DROP TABLE IF EXISTS `#__eshop_zones`;
CREATE TABLE IF NOT EXISTS `#__eshop_zones` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `#__eshop_zones` (`id`, `country_id`, `zone_name`, `zone_code`, `published`) VALUES
...
DROP TABLE IF EXISTS `#__eshop_voucherhistory`;
CREATE TABLE IF NOT EXISTS `#__eshop_voucherhistory` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11) DEFAULT NULL,
  `voucher_id` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `#__eshop_vouchers`;
CREATE TABLE IF NOT EXISTS `#__eshop_vouchers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `voucher_code` varchar(32) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__eshop_wishlists` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_id` int(11) DEFAULT NULL,
  `product_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
