...
class EshopHelper
{
	...
	{
		echo '<div class="copyright" style="text-align:center;margin-top: 5px;"><a href="http://joomdonation.com" target="_blank"><strong>EShop</strong></a> version 2.0.1, Copyright (C) 2012-2013 <a href="http://joomdonation.com" target="_blank"><strong>Ossolution Team</strong></a></div>';
	}
	...
	public static function isCartMode($product)
	{
		...
		{
			if (!EshopHelper::showPrice() || $product->product_call_for_price || ($product->product_quantity <= 0 && !EshopHelper::getConfigValue('stock_checkout') && !$product->product_stock_checkout))
			{
				$isCartMode = false;
			}
		}
	...
	public static function sendReminder($numberProducts, $receivedEmails)
	{
		...
		if (count($products))
		{
			...
			$reminderSubject = JText::_('ESHOP_REMINDER_PRODUCT_THRESHOLD');
