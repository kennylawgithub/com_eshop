			...
			foreach ($this->orders as $order)
			{
				...
				<div class="order-content">
					...
					<div class="order-info" align="right">
						...
						if (EshopHelper::getConfigValue('invoice_enable') && (($order->order_status_id == EshopHelper::getConfigValue('order_status_id') && strpos($order->payment_method, 'os_offline') !== false) || $order->order_status_id == EshopHelper::getConfigValue('complete_status_id')))
						{
							?>
							&nbsp;|&nbsp;
